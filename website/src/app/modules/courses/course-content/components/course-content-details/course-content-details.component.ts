...
@Component({
  ...
  styleUrls: ['./course-content-details.component.scss'],
...
export class CourseContentDetailsComponent implements OnInit {
  ...
  categories: fromModels.CategoryViewModel[];
  course: fromModels.CourseDetailsViewModel;
  ...
  constructor(
      ...
      private _facade: CourseContentFacade,
  ...
  // -----------------------------------------------------------------------------------------------------
     ...
     */
     ...
     {
         // Get the categories
         this._facade.categories$
             .pipe(takeUntil(this._unsubscribeAll))
             .subscribe((categories: fromModels.CategoryViewModel[]) => {
